...
```{r RDD1983, fig.cap="RDD for Unemployment Rates", echo = FALSE, message = FALSE, fig.align='center', out.width="65%", out.height="65%"}
...
Link to ShinyApp (Oil Prices): https://tim-stephens1.shinyapps.io/Oil_Prices_Change_Range/

Link to ShinyApp (Unemployment Rates): https://tim-stephens1.shinyapps.io/Unemployment_Rate_Adjustable_Range/

Link to ShinyApp (Inflation Rate): https://tim-stephens1.shinyapps.io/Inflation_rates_adjustable_range/
